...
namespace MyNetCore.IServices
{
    ...
    public interface ICacheService
    {
        ...
        /// <returns></returns>
        bool Add(string key, object value, DateTime expiresTime);
        ...
        /// <param name="expiresTime">指定过期时间</param>
        /// <returns></returns>
        Task<bool> AddAsync(string key, object value, DateTime expiresTime);
        ...
        /// <returns></returns>
        bool Add(string key, object value, int expiresSecond);
        ...
        /// <param name="expiresSecond">多少秒后过期</param>
        /// <returns></returns>
        Task<bool> AddAsync(string key, object value, int expiresSecond);
        ...
        /// <param name="key">缓存Key</param>
        /// <returns></returns>
        Task<object> GetObjAsync(string key);
